let startBtn = document.getElementById('start'),
    ...
    optionalExpencesBtn = document.getElementsByTagName('button')[1],
...
optionalExpencesBtn.disabled = true;
countBtn.disabled = true;

startBtn.addEventListener('click', function(){
    expencesBtn.disabled = false;
    optionalExpencesBtn.disabled = false;
...
optionalExpencesBtn.addEventListener('click', function(){
    for (let i = 0; i < optionalExpencesItem.length; i++) {
        let opt = optionalExpencesItem[i].value;
        appData.optionalExpences[i] = opt;
        optionalExpencesValue.textContent += appData.optionalExpences[i] + ' ';
    }
});
